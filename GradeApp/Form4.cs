        ...
        private void panel2_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (count > 0) // check if there are rows in the table
            {
                ...
                while (reader.Read())//iterate through all rows
                {
                    ...
                    discription.ForeColor = Color.DarkGray;
                    discription.Font = new Font("Segoe UI", 12, FontStyle.Bold);
                    ...
                    presentage.ForeColor = Color.DarkGray;
                    presentage.Font = new Font("Segoe UI", 12, FontStyle.Bold);
